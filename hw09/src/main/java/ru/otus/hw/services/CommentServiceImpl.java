...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDto findById(long id) {
        return commentRepository.findById(id)
                ...
                .orElseThrow(() -> new EntityNotFoundException(COMMENT_WITH_ID_D_NOT_FOUND.formatted(id)));
    }
    ...
    public void deleteById(long id) {
        if (!commentRepository.existsById(id)) {
            throw new EntityNotFoundException(COMMENT_WITH_ID_D_NOT_FOUND.formatted(id));
        }
    ...
    public CommentDto update(CommentDto commentDto) {
        Comment comment = commentRepository.findById(commentDto.id())
                .orElseThrow(() -> new EntityNotFoundException(COMMENT_WITH_ID_D_NOT_FOUND
