...
import ru.otus.hw.converters.BookShortDtoConverter;
...
class CommentServiceImplTest {
    ...
    void findById_shouldNotThrowLazyException() {
        ...
        assertThat(result.get().book().id()).isEqualTo(1L);
        assertThat(result.get().book().author().fullName()).isNotBlank();
    }
    ...
    void findByBookId_shouldNotThrowLazyException() {
        ...
        assertThat(result).hasSize(3)
                ...
                .allMatch(commentDto -> commentDto.book().id() == 1L)
                .allMatch(commentDto -> !commentDto.book().author().fullName().isBlank());
    }
    ...
    void insert_shouldCreateNewComment() {
        ...
        assertThat(result.book().id()).isEqualTo(bookId);
    ...
    void save_shouldThrowForEmptyText() {
        assertThatThrownBy(() -> commentService.insert("", 1L))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Comment text must not be empty");
    }
